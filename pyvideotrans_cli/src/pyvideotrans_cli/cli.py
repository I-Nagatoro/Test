...
def main():
    ...
    translate_group.add_argument("--llm-api", default="http://localhost:1234/v1", 
                                 help="本地 LLM API 地址")
    translate_group.add_argument("--llm-key", default="not-needed", help="LLM API Key")
    translate_group.add_argument("--llm-model", default="local-model", help="LLM 模型名称")
